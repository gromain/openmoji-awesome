...
fun openmojiColorUrl(unicode: String) = "https://cdn.jsdelivr.net/gh/hfg-gmuend/openmoji@12.4.0/color/svg/$unicode.svg"
fun openmojiBlackUrl(unicode: String) = "https://cdn.jsdelivr.net/gh/hfg-gmuend/openmoji@12.4.0/black/svg/$unicode.svg"
...
fun main(args: Array<String>) {
    ...
    val json = URL("https://raw.githubusercontent.com/hfg-gmuend/openmoji/12.4.0/data/openmoji.json").readText()
